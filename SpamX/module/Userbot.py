...
pongg = PING_MSG if PING_MSG else " 𝙏𝙐𝙎𝙃𝘼𝙍 𝙓 𝙎𝙋𝘼𝙈 "
RIZ_PIC = ALIVE_PIC if ALIVE_PIC else "https://te.legra.ph/file/79baf22b1b142846e5e0f.jpg"
Alivemsg = ALIVE_MSG if ALIVE_MSG else " 𝙏𝙐𝙎𝙃𝘼𝙍 𝙓 𝙎𝙋𝘼𝙈 𝙃𝙀𝙍𝙀  ."
...
rizoel += f"━───────╮•╭───────━\n\n"
rizoel += f"➠ **Source Code:** [•Repo•](https://github.com/X)"
